...
$("nav .mobile-menu-bg .mobile-menu-listItem-ms").on("click", function(){
    ...
    if($(".mobile-menu-bg .mobile-menu-listItem-ms .mobile-submenu").css("height") == "0px"){
        $(".mobile-menu-bg .mobile-menu-listItem-ms .mobile-submenu").css({height:"100px", transition:"all 500ms ease-in-out"})
        console.log("true");
    }
    else if($(".mobile-menu-bg .mobile-menu-listItem-ms .mobile-submenu").css("height") == "100px"){
        $(".mobile-menu-bg .mobile-menu-listItem-ms .mobile-submenu").css({height:"0px", transition:"all 500ms ease-in-out"})
    }
    ...
    if($(".mobile-menu-bg .mobile-menu-listItem-kexino .mobile-submenu").css("height") == "0px"){
        $(".mobile-menu-bg .mobile-menu-listItem-kexino .mobile-submenu").css({height:"100px", transition:"all 500ms ease-in-out"});
        console.log("true");
    }
    else if($(".mobile-menu-bg .mobile-menu-listItem-kexino .mobile-submenu").css("height") == "100px"){
        $(".mobile-menu-bg .mobile-menu-listItem-kexino .mobile-submenu").css({height:"0px", transition:"all 500ms ease-in-out"});
    }
...
$(".body").on('click', function(e){
    ...
    $(".marketing-service-section-03 .row i").hover(function () {
